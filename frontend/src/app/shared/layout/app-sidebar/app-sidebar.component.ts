...
// Definición de tipos para tres niveles
type ChildItem = {
  name: string;
  path: string;
  new?: boolean;
  ...
  othersItems: NavItem[] = [
    {
      ...
      subItems: [
        { 
          ...
          hasChildren: true,
          children: [
            { name: "INGENIERIA QUÍMICA AMBIENTAL", path: "/intranet/tutor/2025/s2/sesiones" }
          ]
        },
        { 
          name: "2025 Semestre 1",
          hasChildren: true,
          children: [
            { name: "INGENIERIA QUÍMICA AMBIENTAL", path: "/intranet/tutor/2025/s1/sesiones" }
          ]
        }
      ]
    }
